...
define("CHARGE_SUCCEEDED", 000);
define("CHARGE_FAILED", 001);
...
/*
  Create instance of the lib and define merchant_id and private_key
  Paybyway(merchant_id, 'private_key')
*/

$payment = new Paybyway\Paybyway(0, 'private_key');
...
/*
  ...
  API and Lib references: https://www.paybyway.com/docs/web_payments/?page=references
*/
